...
class EDIExchangeType(models.Model):
    ...
    def _get_record_name(self, record):
        if hasattr(record.record_id, "_get_edi_exchange_record_name"):
            return record.record_id._get_edi_exchange_record_name(record, self)
        return slugify(record.record_id.name)
